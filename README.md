...
Collection of all 10 Machine Learning Assignments performed in the subject lab for Semester II, AY 2025-26
...
h. counting unique values of data, format of each column, converting variable data type
...
3. Visualize the data using Python by plotting the graphs for assignment no. 1 and 2. Consider a
...
for the two data sets. Dataset link: https://www.kaggle.com/datasets/uciml/pima-indians-
diabetes-database
...
c. metrics
d. Visualize a simple regression model.

11. Assignment on Classification technique. Every year many students give the GRE exam to get
...
Recommendation strength (out of 5), Undergraduate GPA (out of 10), Research Experience (0=no,
1=yes), Admitted (0=no, 1=yes). Admitted is the target variable. 
